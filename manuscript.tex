...
To show~\cref{item:prop_crit} we note that \( A(R) \) is a positive definite function about \( R = R_d\).
...
The desired equilibrium is occurs at \( R=R_d\) and results in \( e_R = 0 \) and \( \Psi = A = 0\).
