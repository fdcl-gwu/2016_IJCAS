...
\begin{figure}[H]%
    \centering 
    \subfigure[Attractive \( A(R) \) \label{fig:attract_error}]{\includegraphics[width=0.33\textwidth]{attract_error} }~
    \subfigure[Repulsive \( B(R) \) \label{fig:avoid_error} ]{\includegraphics[width=0.33\textwidth]{avoid_error} }~
    \subfigure[Combined \( \Psi \) \label{fig:combined_error}]{\includegraphics[width=0.33\textwidth]{combined_error} }%
