...
\begin{align*}
    \Hess(\Psi)\cdot (\delta R,\delta R)\big|_{R=R_d} = \eta^T \frac{1}{2} B \parenth{\tr{G}I -  G} \eta , 
\end{align*}
...
Consider the open neighborhood $D$ of $R=R_d$ defined in~\cref{proof:config_error} The proof of the upper bound of \( A(R) \) is given in~\cite{LeeITCST13}.
