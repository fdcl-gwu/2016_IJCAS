...
\end{align}
where \( e_\Delta = \Delta - \bar{\Delta} \), \( z = [\|e_R\|,\|e_\Omega\|,\|e_\Delta\|]^T\in\R^3 \) and the matrix \(W_1,W_2 \in \R^{3 \times 3}\) are given by
\begin{align*}
	W_1 & = \begin{bmatrix}
...
\begin{gather*}
	...
	\end{bmatrix} .
\end{gather*}
If \( c \) is chosen such that~\cref{eqn:c_bound} is satisfied then all of the matrices \( W_1, W_2 \) and \( M \) are positive definite.
