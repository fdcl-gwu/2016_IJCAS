...
\begin{figure}[H]%
    \centering 
    \subfigure[Attractive \( A(R) \) \label{fig:attract_error}]{\includegraphics{figures/avoid_error.pdf}}~
    \subfigure[Repulsive \( B(R) \) \label{fig:avoid_error} ]{\includegraphics{figures/attract_error.pdf}}~
