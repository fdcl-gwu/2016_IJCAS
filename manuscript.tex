...
The horizontal axes of~\cref{fig:config_error} represent the spherical angles \( \lambda \) and \( \beta \), while the vertical axes represent the unitless magnitude of the error functions defined in~\cref{eqn:psi,eqn:A,eqn:B}.
