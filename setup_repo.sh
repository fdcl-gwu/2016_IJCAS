...
git_repo="git@github.com:skulumani/2016_IJCAS.git"
bb_repo="git@bitbucket.org:shankarkulumani/2016_IJCAS.git"
fdcl_repo="git@github.com:fdcl-gwu/2016_IJCAS.git"
